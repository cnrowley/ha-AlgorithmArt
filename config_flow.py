...
from .const import CONF_HA_URL, CONF_PHOTOFRAME_HOST, DOMAIN
...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_PHOTOFRAME_HOST, default="photoframe.local"): str,
    }
)
...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "host": host,
        "ha_url": ha_url,
        "photoframe_host": data.get(CONF_PHOTOFRAME_HOST, "photoframe.local"),
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(
                ...
                data={
                    ...
                    CONF_PHOTOFRAME_HOST: info.get("photoframe_host", "photoframe.local"),
